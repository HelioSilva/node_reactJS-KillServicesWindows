...
begin
    ...
    begin
         ...
         Service1.lpApplicationName  := lpApplicationName;
         Service1.lpCommandLine      := lpCommandLine;
         Service1.lpCurrentDirectory := lpCurrentDirectory;
